...
public class AzureStorageMCPTools {
    ...
    public ToolResponse createDirectory(@ToolArg(name = "directory_name", description = "The directory name to be created. The directory name cannot have spaces nor special characters.") String directoryName) {
        ...
        return ToolResponse.success(new TextContent("Directory  " + directory.getBlobContainerName() + " has been created"));
    }
    ...
    public ToolResponse createFile(@ToolArg(name = "directory_name", description = "The directory name to be created. The directory name cannot have spaces nor special characters.") String directoryName,
        ...
        return ToolResponse.success(new TextContent("File name " + file.getBlobName() + " created in the directory " + directory.getBlobContainerName() + " with content size " + content.length()));
    }
    ...
    public ToolResponse readFile(@ToolArg(name = "directory_name", description = "The directory name where the file is located. The directory name cannot have spaces nor special characters.") String directoryName,
                                 @ToolArg(name = "file_name", description = "The name of the file to be read in the directory. The file name cannot have spaces nor special characters and its file extension must be '.txt'.") String fileName) {
    ...
    public ToolResponse deleteDirectory(@ToolArg(name = "directory_name", description = "The directory name to be deleted. The directory name cannot have spaces nor special characters.") String directoryName) {
        ...
        return ToolResponse.success(new TextContent("Directory " + directory.getBlobContainerName() + " has been deleted"));
    }

    @Tool(name = "lists_files_under_a_directory", description = "Lists all the files under a directory.")
    public ToolResponse listDirectories(@ToolArg(name = "directory_name", description = "The root directory name from where it lists all the files. The directory name cannot have spaces nor special characters.") String directoryName) {
