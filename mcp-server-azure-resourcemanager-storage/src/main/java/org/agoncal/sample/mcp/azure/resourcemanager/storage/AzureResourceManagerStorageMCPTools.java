...
public class AzureResourceManagerStorageMCPTools {
    ...
    @Tool(name = "creates_a_storage_account", description = """
        Creates a new Storage Account in an existing Azure Resource Group.
        A Storage Account in Azure provides a unique namespace to store and access Azure Storage data objects, such as blobs, file shares, queues, tables, and disks.
        If the Storage Account already exists, the operation fails.
        """)
    ...
    @Tool(name = "deletes_a_storage_account", description = """
        Deletes an existing Storage Account.
        If the Storage Account does not exists, the operation fails.
        """)
